...
print("\033[1m" + "*********Rectangle and Square Area Calculator*********" + color.END)
...
while True:
    ...
    if input1 == "S" or input1 == "s" or input1 == "square" or input1 == "Square":
        ...
        print("\033[92m" + "The area of the rectangle is " + str(
            area1(length1, width)) + color.END + "\n-----------------------------------")
        continue
